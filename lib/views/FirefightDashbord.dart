...
class FirefightDashboard extends StatefulWidget {
  //String phoneNumber;
  //String typeOfUser;
  AuthController authController;
  FirefightDashboard(this.authController, {super.key});
  ...
  @override
  State<FirefightDashboard> createState() => _FirefightDashboardState();
}

class _FirefightDashboardState extends State<FirefightDashboard> {
  String? _mapStyle;
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            ...
                            Text('number of interventions : ${metric['countIntervention']}'),
                            ...
                            greenButton('cancel action', (){
                              firestore.collection('Firefighter').doc(firefighter[index].id).update({"occupee": "free"});
                            }):Center()
                          ],
                        ),
                        onTap: () {
